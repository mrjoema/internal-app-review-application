...
exports.reconcile_assignments = exports.assign_apps = void 0;
 ...
 */
const assign_apps = (reviewers, assign_rule, apps_map) => {
    let result = new Map();
    ...
    (0, dev_utils_1.print_map_with_object_values)(result, "Final result");
    return result;
};
 ...
 */
const assign_per_category = (category, apps, assign_rule, reviewers, start_index_for_remaining) => {
    ...
    (0, dev_utils_1.print_map)(remaining_count_map, `The amount of apps in ${category} that each reviwer needs to review`);
...
const merge_results = (original, update) => {
 ...
 */
const reconcile_assignments = (original, decline_records, reviewers) => {
    const adj_result = new Map(original);
    ...
    (0, dev_utils_1.print_map_with_object_values)(adj_result, "Reconciled result");
    return adj_result;
};
exports.reconcile_assignments = reconcile_assignments;
//# sourceMappingURL=distribuitor_utils.js.map